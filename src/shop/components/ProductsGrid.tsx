...
export const ProductsGrid = ({products}: Props) => {
    ...
    // obtiene, de la url activa, el modo de vista o asigna valor 'grid' por defecto
    const viewMode = searchParams.get('viewMode') || 'grid';

    // func manejadora del modo de vista, recibe mode ('grid' o 'list')
    const handleViewModeChange = (mode: 'grid' | "list") => {
        // asigna el valor de mode, al url param 'viewMode'
        searchParams.set('viewMode', mode);
        // actualiza el estado de los url params
            ...
            <div className="container mx-auto">
                ...
                <div className="flex gap-8">
                    ...
                    <div className="flex-1">
                        <div
                            // condicional para el modo de vista de products
                            className={
                                viewMode === 'grid' 
